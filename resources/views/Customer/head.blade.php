...
<head>
    ...
    <link rel="stylesheet" href="/customer/assets/css/skins/skin-demo-7.css">
    <link rel="stylesheet" href="/customer/assets/css/demos/demo-7.css"> 
    @endif 
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-4">
                            <div class="widget widget-about">
                                <img src="/customer/assets/images/demos/demo-7/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
                            ...
                            <div class="tab-content" id="tab-content-5">
                                ...
                                <form method="POST" action="/customer/register">
                                      @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="register-email">NIC *</label>
                                        ...
                                        <!-- <div class="form-group">
                                            <label for="register-email">Type *</label>

                                            <div class="select-custom">
                                            <select name="size" id="size" class="form-control">
                                                <option value="1" selected="selected">Buyer</option>
