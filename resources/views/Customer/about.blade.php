...
<div class="page-wrapper">
    ...
    <main class="main">
            ...
            <div class="page-content pb-3">
                ...
                <div class="bg-image pt-7 pb-5 pt-md-12 pb-md-9" style="background-image: url(/customer/assets/images/backgrounds/bg-4.jpg)">
                    <div class="container">
                        <div class="row">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-1.jpg" alt="member photo">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-2.jpg" alt="member photo">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-3.jpg" alt="member photo">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-4.jpg" alt="member photo">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-5.jpg" alt="member photo">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-6.jpg" alt="member photo">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-7.jpg" alt="member photo">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="/customer/assets/images/team/about-2/member-8.jpg" alt="member photo">
