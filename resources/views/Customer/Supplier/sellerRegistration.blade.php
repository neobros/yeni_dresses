     ...
     @include('Customer.header')
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('/customer/assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Become a Seller<span>Seller Guidelines</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                        ...
                        <div class="col-md-11 col-xl-10">
                            <div class="cta-content">
                                <div class="cta-heading">
                                    <h3 class="cta-title text-right">By continuing to use this website, you agree to these terms and guidelines.</h3><!-- End .cta-title -->
                                </div><!-- End .cta-heading -->
                                
                                <div class="cta-text">
                                    <p>We reserve the right to update these guidelines at any time. Any changes will be effective immediately upon posting.</p>
                                </div><!-- End .cta-text -->
                                <a href="/seller/registrationAgreed" class="btn btn-primary btn-rounded"><span>Agreed</span><i class="icon-long-arrow-right"></i></a>
                            </div><!-- End .cta-content -->
                        </div><!-- End .col-xl-7 -->
                    </div><!-- End .row -->
                </div>
