          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="/seller/itemManagement/addItem">Add Item</a>
                </li>
              </ul>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <form method="POST" action="/seller/itemManagement/storeItem" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                          <div class="col-md-12">                    
                            ...
                            <div class="form-group form-inline">
                              ...
                              <div class="col-md-9 p-0">
                                <input type="number" name="price" class="form-control input-full" required>
                              </div>
                            </div>
                            ...
                            <div class="form-group form-inline">
                              ...
                              <div class="col-md-9 p-0">
                                <input type="number" name="quantity" class="form-control input-full" required>
                              </div>
                            </div>
