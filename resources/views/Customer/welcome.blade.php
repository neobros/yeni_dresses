...
@section('content')
    <div class="page-wrapper">
        ...
        <main class="main">
                                        ...
                                        <div class="product product-7 text-center">
                                            ...
                                            <figure class="product-media">
                                                <a href="/product/{{$item->item_ID}}">
                                                    ...
                                                    <img src="{{ asset('uploads/' . $photos[1]) }}" alt="Product image" class="product-image-hover">
                                                </a>
                                                ...
                                                <div class="product-action">
                                                    <a href="/product/{{$item->item_ID}}" class="btn-product btn-cart"><span>add to cart</span></a>
            ...
            <div class="container-fluid">
                <div class="heading heading-center mb-3">
                    <h2 class="title">Wearing Items</h2><!-- End .title -->

                    <ul class="nav nav-pills justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="new-women-link" data-toggle="tab" href="#new-women-tab" role="tab" aria-controls="new-women-tab" aria-selected="true"></a>
                        </li>
                        <!-- <li class="nav-item">
